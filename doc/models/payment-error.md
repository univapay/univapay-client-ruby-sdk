...
| `message` | `String` | Optional | A brief message detailing why the payment failed. |
| `detail` | `String` | Optional | Further specific details regarding the payment failure, if available. |
