...
| `payment_type` | `String` | Required, Constant | Payment method type. Always `qr_merchant` for this variant.<br><br>**Value**: `'qr_merchant'` |
...
```ruby
qr_merchant_transaction_token = QrMerchantTransactionToken.new(
