...
module UnivapayClientSdk
  ...
  class KonbiniTransactionToken < BaseModel
    SKIP = Object.new
    ...
    # @return [TokenResponseKonbiniData]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      data = TokenResponseKonbiniData.from_hash(hash['data']) if hash['data']
      ...
      KonbiniTransactionToken.new(data: data,
                                  id: id,
                                  store_id: store_id,
                                  email: email,
                                  active: active,
    ...
    # @param [KonbiniTransactionToken | Hash] The value against the validation is performed.
        ...
        return (
          APIHelper.valid_type?(value.payment_type,
            ...
            APIHelper.valid_type?(value.data,
                                  ->(val) { TokenResponseKonbiniData.validate(val) },
                                  is_model_hash: true)
        )
      end
