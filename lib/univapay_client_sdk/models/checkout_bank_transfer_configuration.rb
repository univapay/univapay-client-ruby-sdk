...
module UnivapayClientSdk
  ...
  class CheckoutBankTransferConfiguration < BaseModel
    SKIP = Object.new
    ...
    # @return [CheckoutBankTransferMatchAmount]
    ...
    # Number of unused virtual bank accounts that triggers provisioning of
    # additional accounts.
    # @return [Integer]
    ...
    # Whether a notification is sent when a requested bank transfer charge is
    # canceled.
    # @return [TrueClass | FalseClass]
    ...
    # Whether a notification is sent when a deposit exceeds the requested
    # amount.
    # @return [TrueClass | FalseClass]
    ...
    # ISO-8601 duration before expiration at which a reminder notification is
    # sent.
    # @return [String]
    ...
    def self.from_hash(hash)
      ...
      CheckoutBankTransferConfiguration.new(enabled: enabled,
    ...
    def to_s
      ...
      " #{@expiration}, expiration_time_shift: #{@expiration_time_shift},"\
      " virtual_bank_accounts_threshold: #{@virtual_bank_accounts_threshold},"\
      " virtual_bank_accounts_fetch_count: #{@virtual_bank_accounts_fetch_count},"\
    ...
    def inspect
      ...
      " expiration: #{@expiration.inspect}, expiration_time_shift:"\
      " #{@expiration_time_shift.inspect}, virtual_bank_accounts_threshold:"\
