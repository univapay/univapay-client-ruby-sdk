...
module UnivapayClientSdk
  ...
  class DirectDebitBankTransferList < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # List of resources.
    # @return [Array[DirectDebitBankTransfer]]
    attr_accessor :items
    ...
    def self.from_hash(hash)
      ...
      unless hash['items'].nil?
        ...
        hash['items'].each do |structure|
          items << (DirectDebitBankTransfer.from_hash(structure) if structure)
        end
      end
      ...
      DirectDebitBankTransferList.new(items: items,
                                      has_more: has_more,
                                      additional_properties: additional_properties)
    end
