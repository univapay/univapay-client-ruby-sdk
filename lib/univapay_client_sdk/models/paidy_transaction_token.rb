...
module UnivapayClientSdk
  ...
  class PaidyTransactionToken < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      data = TokenResponsePaidyData.from_hash(hash['data']) if hash['data']
      ...
      PaidyTransactionToken.new(data: data,
                                id: id,
                                store_id: store_id,
                                email: email,
                                active: active,
    ...
    # @param [PaidyTransactionToken | Hash] The value against the validation is performed.
        ...
        return (
          APIHelper.valid_type?(value.payment_type,
            ...
            APIHelper.valid_type?(value.data,
                                  ->(val) { TokenResponsePaidyData.validate(val) },
                                  is_model_hash: true)
        )
      end
