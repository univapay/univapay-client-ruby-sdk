...
module UnivapayClientSdk
  # Request payload for updating a registered bank account. Omitted fields are
  # left unchanged.
  class DirectDebitBankAccountUpdateRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(user_number: SKIP, bank_code: SKIP, bank_name: SKIP,
    ...
    def self.from_hash(hash)
      ...
      DirectDebitBankAccountUpdateRequest.new(user_number: user_number,
                                              bank_code: bank_code,
                                              bank_name: bank_name,
