...
module UnivapayClientSdk
  # CVV re-confirmation policy applied to recurring card charges (subscriptions
  # and tokens with recurring privilege).
  class RecurringCvvConfirmation < BaseModel
    SKIP = Object.new
    ...
    # @return [Array[CheckoutMoneyAmount]]
    ...
    def self.from_hash(hash)
      ...
      unless hash['threshold'].nil?
        ...
        hash['threshold'].each do |structure|
          threshold << (CheckoutMoneyAmount.from_hash(structure) if structure)
        end
      end
      ...
      RecurringCvvConfirmation.new(enabled: enabled,
                                   threshold: threshold,
                                   additional_properties: additional_properties)
    end
