...
module UnivapayClientSdk
  ...
  class CheckoutQrScanConfiguration < BaseModel
    SKIP = Object.new
    ...
    # QR-scan gateways disabled for the merchant. Common values include
    # `alipay`, `alipay_plus`, `pay_pay`, `we_chat`, `univapay`, and `test`.
    # `null` when no gateway is forbidden.
    # @return [Array[String]]
    ...
    def self.from_hash(hash)
      ...
      CheckoutQrScanConfiguration.new(enabled: enabled,
