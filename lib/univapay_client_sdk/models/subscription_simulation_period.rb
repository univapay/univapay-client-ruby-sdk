...
module UnivapayClientSdk
  # Billing frequency for the simulated schedule. Includes `bimonthly`, which is
  # not offered on `SubscriptionPeriod` for live subscription creation.
  class SubscriptionSimulationPeriod
