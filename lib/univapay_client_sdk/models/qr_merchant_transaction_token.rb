...
module UnivapayClientSdk
  ...
  # Mode) payment type.
  class QrMerchantTransactionToken < BaseModel
    SKIP = Object.new
    ...
    # @return [TokenResponseQrMerchantData]
    attr_accessor :data
    ...
    # @param [QrMerchantTransactionToken | Hash] The value against the validation is performed.
