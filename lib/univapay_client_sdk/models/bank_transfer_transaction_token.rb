...
module UnivapayClientSdk
  ...
  class BankTransferTransactionToken < BaseModel
    SKIP = Object.new
    ...
    # @return [TokenResponseBankTransferData]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      data = TokenResponseBankTransferData.from_hash(hash['data']) if hash['data']
      ...
      BankTransferTransactionToken.new(data: data,
                                       id: id,
                                       store_id: store_id,
                                       email: email,
                                       active: active,
    ...
    # @param [BankTransferTransactionToken | Hash] The value against the validation is performed.
        ...
        return (
          APIHelper.valid_type?(value.payment_type,
            ...
            APIHelper.valid_type?(value.data,
                                  ->(val) { TokenResponseBankTransferData.validate(val) },
                                  is_model_hash: true)
        )
      end
