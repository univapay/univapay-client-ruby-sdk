...
module UnivapayClientSdk
  ...
  class CardTransactionToken < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      data = TokenResponseCardData.from_hash(hash['data']) if hash['data']
      ...
      CardTransactionToken.new(data: data,
                               id: id,
                               store_id: store_id,
                               email: email,
                               active: active,
    ...
    # @param [CardTransactionToken | Hash] The value against the validation is performed.
        ...
        return (
          APIHelper.valid_type?(value.payment_type,
            ...
            APIHelper.valid_type?(value.data,
                                  ->(val) { TokenResponseCardData.validate(val) },
                                  is_model_hash: true)
        )
      end
