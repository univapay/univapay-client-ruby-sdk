...
module UnivapayClientSdk
  ...
  class TransactionTokenBase < BaseModel
    SKIP = Object.new
    ...
    def initialize(id: SKIP, store_id: SKIP, email: SKIP, active: SKIP,
    ...
    def self.from_hash(hash)
      ...
      TransactionTokenBase.new(id: id,
                               store_id: store_id,
                               email: email,
                               active: active,
                               mode: mode,
    ...
    # @param [TransactionTokenBase | Hash] The value against the validation is performed.
    ...
    def to_s
      ...
      " last_used_on: #{@last_used_on}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@updated_on.inspect}, last_used_on: #{@last_used_on.inspect}, additional_properties:"\
