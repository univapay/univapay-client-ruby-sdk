...
module UnivapayClientSdk
  ...
  class SubscriptionSimulationPlanSettings < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # Plan type selector.
    # @return [SimulationPlanSettingsType]
    ...
    # Total target amount for the fixed_cycle_amount plan. Must not exceed the
    # requested amount.
    # @return [Integer]
    ...
    def self.from_hash(hash)
      ...
      SubscriptionSimulationPlanSettings.new(plan_type: plan_type,
