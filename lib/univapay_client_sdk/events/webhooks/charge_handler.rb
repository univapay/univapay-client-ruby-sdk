...
module UnivapayClientSdk
  # ChargeHandler is responsible for verifying request signatures
  # and parsing incoming charge events into strongly typed objects.
  class ChargeHandler
    include CoreLibrary
    # Creates a new instance of the ChargeHandler.
    def initialize; end

    # Parse the event.
    #
    # @param [Rack::Request] request The incoming HTTP request containing the event payload.
    # @return[ChargeWebhookEvent, UnknownEvent]
    # ChargeWebhookEvent for successful parsing;
