...
module UnivapayClientSdk
  # SubscriptionHandler is responsible for verifying request signatures
  # and parsing incoming subscription events into strongly typed objects.
  class SubscriptionHandler
    include CoreLibrary
    # Creates a new instance of the SubscriptionHandler.
    def initialize; end

    # Parse the event.
    #
    # @param [Rack::Request] request The incoming HTTP request containing the event payload.
    # @return[SubscriptionWebhookEvent, UnknownEvent]
    # SubscriptionWebhookEvent for successful parsing;
    # UnknownEvent for
    # unknown events.
